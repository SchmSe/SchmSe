## 💫 About Me:
I am a **Data Scientist with a background in General Management**, focused on translating complex data into actionable business strategies.<br><br>With **10+ years of experience as a Managing Director**, I understand the operational challenges businesses face. I combine this leadership experience with **strong analytical skills (Python, R)** and a scientific background in Sociology and Economics to solve problems in **People Analytics** and **Business Intelligence**.<br><br>- 🔭 **I’m currently working on:** A showcase of my Master's thesis about the impact of AI on New Work paradigms.<br>- 🌱 **I’m currently learning:** SQL, PowerBI, and advanced Predictive Modeling.<br>- 💼 **My goal:** Helping companies drive decision-making through data – without losing the human element.<br>- ⚡ **Fun fact:** I hold proficiency certificates in Latin, Ancient Greek, and Hebrew, demonstrating a long-standing passion for analyzing complex, structured systems.<br><br>
...
---
[![](https://visitcount.itsvg.in/api?id=SchmSe&icon=0&color=1)](https://visitcount.itsvg.in)
